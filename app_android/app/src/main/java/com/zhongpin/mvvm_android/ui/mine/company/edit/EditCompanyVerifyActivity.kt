...
import com.zhongpin.app.databinding.ActivityCompanyVerifyEditBinding
...
class EditCompanyVerifyActivity : BaseVMActivity<EditCompanyVerifyViewModel>() {
    ...
    fun  autoFillEntInfo(item: CompanyListItemResponse?) {
        ...
        mBinding.editCompanyname.setText(item.name ?: "")
        mBinding.editCompanyAddress.setText(item.address ?: "")
        mBinding.editXinYongCode.setText(item.unite ?: "")
        mBinding.editFaren.setText(item.legal ?: "")
        mBinding.editPhone.setText(item.mobile ?: "")
