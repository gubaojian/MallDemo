...
class GlideBannerImageAdapter (imageUrls: List<UserInfoResponse>) : BannerAdapter<UserInfoResponse, GlideBannerImageAdapter.ImageHolder>(imageUrls)  {
