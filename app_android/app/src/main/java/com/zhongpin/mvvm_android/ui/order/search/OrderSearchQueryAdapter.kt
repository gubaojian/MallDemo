...
class OrderSearchQueryAdapter(val mActivity: AppCompatActivity, data: MutableList<CompanyListItemResponse>)
    : BaseQuickAdapter<CompanyListItemResponse, OrderSearchQueryAdapter.VH>(data) {


    override fun onBindViewHolder(
        holder: OrderSearchQueryAdapter.VH,
        position: Int,
