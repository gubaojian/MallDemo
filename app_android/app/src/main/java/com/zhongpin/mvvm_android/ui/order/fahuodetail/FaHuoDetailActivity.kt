...
import com.zhongpin.app.databinding.ActivityFahuoDetailBinding
...
@EventBusRegister
class FaHuoDetailActivity : BaseVMActivity<FaHuoDetailViewModel>() {


    private lateinit var mBinding: ActivityFahuoDetailBinding;

    private var orderListItem: CompanyListItemResponse? = null

    private val faHuoListModels: MutableList<CompanyListItemResponse> = mutableListOf()

    private lateinit var mFaHuoListAdapter: FaHuoListAdapter;
    ...
    override fun createContentViewByBinding(inflater: LayoutInflater, container: ViewGroup?): View {
        mBinding = ActivityFahuoDetailBinding.inflate(layoutInflater, container, false)
    ...
    override fun initView() {
        ...
        faHuoListModels.add(CompanyListItemResponse(10, 10, "", "", "" , "", "", "", "", "", "", "", 0, 0, 0))
        faHuoListModels.add(CompanyListItemResponse(10, 10, "", "", "" , "", "", "", "", "", "", "", 0, 0, 0))
        faHuoListModels.add(CompanyListItemResponse(10, 20, "", "", "" , "", "", "", "", "", "", "", 0, 0, 0))
        faHuoListModels.add(CompanyListItemResponse(10, 20, "", "", "" , "", "", "", "", "", "", "", 0, 0, 0))
        ...
        mFaHuoListAdapter = FaHuoListAdapter(this@FaHuoDetailActivity, faHuoListModels);
        mBinding.timelineRecyclerView.layoutManager = layoutManager;
        mBinding.timelineRecyclerView.adapter = mFaHuoListAdapter;
    ...
    fun onFeedback(feedbackEvent: FeedbackEvent) {
        finish();
    }

    fun showDeleteConfirmDialog() {
        val builder = AlertDialog.Builder(this@FaHuoDetailActivity)
