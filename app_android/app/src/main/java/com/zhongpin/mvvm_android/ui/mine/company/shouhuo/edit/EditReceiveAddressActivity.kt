package com.zhongpin.mvvm_android.ui.mine.company.shouhuo.edit
...
import com.zhongpin.app.databinding.ActivityEditReceiveAddressBinding
...
class EditReceiveAddressActivity : BaseVMActivity<EditReceiveAddressViewModel>(), OnAddressPickedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            addressItem = intent.getSerializableExtra("addressItem", AddressListItemResponse::class.java)
        }
